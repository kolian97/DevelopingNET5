...
namespace DevelopingNET5
{
    public class Server
    {
        ...
        void Register(Message message, IPEndPoint fromEp)
        {
            ...
            clients[message.FromName] = fromEp;
        ...
        void RequestUnreadMessages()
        {
            var listRequest = new Message
            {
                ...
                FromName = "UserName" // Укажите имя пользователя
            };
        ...
        void ProcessMessage(Message message, IPEndPoint fromep)
        {
            ...
            switch (message.Command)
            {
                ...
                case Command.List: // Новый случай обработки команды List
